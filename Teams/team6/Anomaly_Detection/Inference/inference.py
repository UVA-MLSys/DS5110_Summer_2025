...
# sys.path.append('C:/Users/chris/AI-for-Astronomy/code/Anomaly Detection/') #adjust based on your system's directory
sys.path.append('C:/Users/prath/Desktop/UVAMASTERS/dataeng2/AI-for-Astronomy-main/code/Anomaly Detection') #adjust based on your system's directory
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type = str, default = '6.pt')
